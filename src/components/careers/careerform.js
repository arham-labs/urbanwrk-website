        ...
        <div className="flex flex-col lg:flex-row md:gap-14 lg:gap-16 xl:gap-24 2xl:gap-32">
          ...
          <div className="flex flex-col order-1 sm:order-2 max-lg:pt-[48px] justify-center">
            ...
            <p className="py-4 max-lg:py-6">
              Let&apos;s create spaces that inspire, innovate, and ignite the
              best in everyone.
            </p>
            <form
            ...
            >
              ...
              <div className="mb-2">
                <label className="block font-semibold" htmlFor="areas">
                  DEPARTMENT:
                </label>
                <Controller
                  control={control}
                  name="field_domain_of_interest"
                  render={({ field }) => (
                    <>
                      <BasicSelectDrop
                      ...
                      {errors.field_domain_of_interest && (
                        <span className="text-red-500">
                          {errors.field_domain_of_interest.message}
                        </span>
                      )}
                    </>
                  )}
              ...
              <div className="mb-4">
                <label className="block font-semibold" htmlFor="resume">
                  RESUME:
                </label>
                <Controller
                  control={control}
              ...
              >
                <LoadingButton
                  ...
                  className={`border-black border  px-4 gap-2 flex items-center h-[36px] w-[112px] transition-all  ease-in-out  ${
                    isButtonDisabled
