            ...
            <div className="w-[88%] m-auto flex flex-col justify-center text-center items-center">
                <div className="w-full lg:w-[600px] mb-5 lg:mb-10">
                    <div className="flex items-start gap-0 lg:gap-2">
                        ...
                        <p className="leading-[22px] lg:leading-[40px] text-sm lg:text-2xl font-semibold mt-2 lg:mt-5">By redefining the benchmark for the workspace experience, we&#39;re giving the power back to the doers - to produce their finest
