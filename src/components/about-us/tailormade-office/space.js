            ...
            <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-0">
                ...
                <div className="px-6 lg:px-0 w-full lg:w-1/2 flex flex-col gap-7 lg:gap-14">
                    <div className="w-full lg:w-[65%] 2xl:w-[70%] lg:ml-24 mr-auto flex flex-col items-start lg:items-start gap-5 lg:gap-10">
                        ...
                        <div className="group">
                            <a href="mailto:hello@urbanwrk.com" className="text-base border-black border px-4 gap-2 flex text-black items-center h-[36px] w-fit transition-all ease-in-out group-hover:bg-primary group-hover:border-primary group-hover:text-white cursor-pointer
