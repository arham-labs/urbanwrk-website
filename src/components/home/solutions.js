...
export default function Solutions() {
    ...
    const data = [
        ...
        { img: "/images/home/solutionCardl6.png", title1: "Advertise", title2: "With Us", desc: "Promotional spaces across prime real estate to put your brand on top of minds.",link:"/solutions/advertise-with-us" }
    ]
    return (
        <div>
