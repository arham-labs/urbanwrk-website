    ...
    return (
        <div>
            <div className='relative'>
                ...
                <div className='absolute top-20 inset-x-0 flex justify-center items-center font-medium text-[65px] max-md:text-[28px]'>
                    <div >What are you looking for?</div>
                </div>
                <div className='absolute bottom-60 inset-x-0 flex justify-center items-center font-medium text-[65px]'>
                    <p className='text-[30px] py-20 text-white w-[40%] text-center max-md:text-[20px]'>
                ...
                <div className='absolute bottom-16 inset-x-0 flex justify-center items-center font-medium text-[65px] px-5 '>
