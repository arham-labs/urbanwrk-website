        ...
        <div>
            <div className='relative h-[800px] md:h-[875px] '>
                ...
                <div className='absolute  top-14   md:top-20 inset-x-0 flex justify-center items-center font-medium text-6xl max-md:text-[28px] max-md:tracking-[-0.56px]'>
                    <div >What are you <span className='font-kepler max-md:text-[28px] text-6xl '>
                        looking for?
                    </span></div>
                </div>
                ...
                <div className='absolute bottom-16  md:bottom-20 inset-x-0 flex justify-center items-center font-medium text-[65px] px-5  '>
                    <div className='px-10 bg-bglight1 max-md:w-full gap-10 flex-wrap py-4 relative flex justify-between  max-md:flex-col max-md:px-5 max-md:gap-6 max-md:py-6 '>
