...
export default function SolutionSlider() {
    ...
    const data = [
        ...
        { img: "/images/home/solutionCardl5.png", title1: `Events &`, title2: "Shoots", desc: "Tailormade event solutions with hospitality and catering for up to 250 people.",link:"/solutionsLanding/events-launches" },
