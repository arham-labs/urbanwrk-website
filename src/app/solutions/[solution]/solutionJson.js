...
export const Jsons = {
  SolutionData: [
    ...
    },
    {
      ...
      metaTitle: "UrbanWrk Studios",
      metaDescription: "UrbanWrk Studios are equipped with cutting-edge facilities for seamless, unforgettable events. Secure your venue today!",
      breadcrumbsTitle: "UrbanWrk Studios",
      name: "urbanwrk-studios",
      titleImgDesk:
      ...
      title1: "UrbanWrk Studios",
      title2: "",
      title3: "Flexible workspaces, ready from day one.",
      card1_titile1: "Move in.",
      card1_titile2: "Scale up.",
      card1_titile3:
        "Step into UrbanWrk Studios- fully serviced, zero-capex offices. Flexible by design, they scale with your business.",
      brandData: [
        "Flexible leases: from short-term to long-term, expandable as you grow.",
        "Tailored layouts: your brand, your way. Spaces designed around how your team actually works.",
        "Sustainably built: IGBC & LEED certified, designed by experts.",
        "All-inclusive: everything handled- utilities, reception, admin, security. You focus on what matters.",
        "Work + life: access to coworking zones, lounges, café and gym.",
      ],
      card2: [
        {
    ...
    },
    {
      ...
      title2: "",
      title3: "Project a strong business presence.",
      card1_titile1: "Smart costs",
      card1_titile2: "Effective growth",
      card1_titile3:
        "Designed for entrepreneurs, freelancers, and businesses looking for a prestigious corporate presence without the need for a physical office. Our virtual office solutions give you a prime business address, elevating your credibility and giving you flexibility to grow at your pace.",
      brandData: [
