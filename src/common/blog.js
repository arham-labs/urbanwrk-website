    ...
    return (
        <div className="bg-bglight6 py-16 lg:py-24">
            <div className="px-6 max-w-[1920px] mx-auto 2xl:px-40 lg:px-[120px]">
                <span className="text-2xl font-medium block mb-12">BLOG</span>
                <div className="flex flex-col lg:flex-row items-start gap-12 lg:gap-16">
                    <div className="w-full lg:w-1/2 flex flex-col gap-8">
                        <div className="relative">
                            ...
                            <Image src={Blog2} alt="blog-1" className="aspect-square lg:aspect-[5/4] w-full" />
                        </div>
                        <div className="w-full lg:w-[85%] flex flex-col gap-2 lg:gap-4">
                            ...
                            <p className="leading-6 text-sm font-medium">A workspace is not just about the work. It is also about providing employees a space that allows them the freedom to work where, when, and how they want.</p>
                        </div>
                    </div>
                    <div className="w-full lg:w-1/2 flex flex-col gap-8">
                        <div className="relative">
                            ...
                            <Image src={Blog1} alt="blog-1" className="aspect-square lg:aspect-[26/35] w-full" />
                        </div>
                        <div className="w-full lg:w-[85%] flex flex-col gap-2 lg:gap-4">
                            ...
                            <p className="leading-6 text-sm font-medium">Locking in on the perfect space is the foremost step to creating a productive office for your company. The next step, however, is even more crucial — deciding the layout of that space.</p>
                        </div>
                    </div>
                </div>
            </div>
